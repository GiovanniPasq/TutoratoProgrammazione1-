...
class Person{
    private:
        ...
        Lavoro lavoro;
    public:
        Person(string name,string surname,int age, string birth, string nomeL, int g):lavoro(nomeL,g){
            this->name=name;
        ...
        void setLavoro(Lavoro lavoro){
            this->lavoro= Lavoro(lavoro.getNome(),lavoro.getGuadagno());
        }
...
int main(){
    Person *p = new Person("antonio","rossi",22,"29-12-90","insegnante",1800);
